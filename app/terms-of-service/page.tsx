      ...
      <section className="pt-32 pb-16 md:pt-40 md:pb-32">
        <div className="max-w-3xl mx-auto px-6 md:px-12 space-y-8">
          ...
          <div className="prose prose-lg text-foreground/70 space-y-6">
            ...
            <p>These Terms of Service govern your use of the adventures.nechabest.com website and services offered by Nechabest Adventures.</p>
            ...
            <p>Nechabest Adventures acts as an organizer for tour packages. We are not liable for any injury, loss, or damage that may occur during tours. Participants are responsible for their own safety and should have appropriate travel insurance.</p>
