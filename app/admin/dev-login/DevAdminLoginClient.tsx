...
export default function DevAdminLoginClient() {
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl">
          ...
          <p className="text-white/50 text-sm text-center mb-8">
            Enter the{' '}
            <code className="text-green-400 bg-white/5 px-1.5 py-0.5 rounded">DEV_ADMIN_PASSWORD</code>{' '}
            from your{' '}
            <code className="text-green-400 bg-white/5 px-1.5 py-0.5 rounded">.env.local</code>
          </p>
          ...
          <div className="mt-6 pt-6 border-t border-white/10">
            <p className="text-white/30 text-xs text-center leading-relaxed">
              This login is only available in development.
              <br />
              Production uses Clerk authentication.
            </p>
          </div>
        </div>
      </div>
