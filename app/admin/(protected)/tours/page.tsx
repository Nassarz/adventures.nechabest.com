...
import { Plus, Edit, Trash2, Search, X, Check, PlusCircle, MinusCircle } from 'lucide-react';
  ...
  return (
    <AdminLayout>
      <AdminHeader
        ...
        subtitle="Create, edit and manage all adventure tours and packages"
      />
                    ...
                    {filteredTours.map((tour) => (
                      <tr key={tour.id} className="border-b border-black/5 hover:bg-black/2 transition-all">
                        ...
                        <td className="px-6 py-4 text-black/60">
                          {tour.showOnHome ? 'Home + Adventures' : 'Adventures only'}
                        </td>
            ...
            >
              <div className="flex justify-between items-center pb-4 border-b border-black/10">
                <h2 className="text-2xl font-bold text-black">
                  {editingId ? 'Edit Adventure Tour Package' : 'Add New Adventure Tour'}
                </h2>
                <button
                  onClick={() => setIsModalOpen(false)}
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        placeholder="e.g., Gorilla Trekking in Bwindi"
                    ...
                    <div className="rounded-lg border border-black/10 p-4">
                      <label className="flex items-center gap-3 cursor-pointer">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-black/60">Unchecked tours appear only on the Adventures page.</p>
                        </div>
                      </label>
                    </div>
                          ...
                          <div key={index} className="p-4 bg-black/2 rounded-xl border border-black/5 space-y-3 relative group">
                            ...
                            <div className="grid grid-cols-1 gap-3">
                              ...
                              <input
                                ...
                                placeholder="Location (e.g. Bwindi Impenetrable Forest)"
                                className="w-full px-3 py-2 border border-black/10 bg-white rounded-lg focus:outline-none focus:border-nature text-sm text-black/80"
                              />
                              <input
                                type="text"
                                ...
                                placeholder="Accommodation (e.g. Bwindi Lodge)"
                                className="w-full px-3 py-2 border border-black/10 bg-white rounded-lg focus:outline-none focus:border-nature text-sm text-black/80"
                              />
                              <input
                                type="text"
