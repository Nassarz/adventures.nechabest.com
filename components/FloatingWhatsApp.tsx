      ...
      <AnimatePresence>
        {showTooltip && (
          <motion.div
            ...
            className="relative"
          >
            <div className="bg-white text-[#1A3C34] rounded-2xl rounded-br-md px-4 py-3 shadow-2xl border border-black/5 max-w-[220px]">
              <p className="text-xs font-bold text-[#1A3C34]">Chat with us 👋</p>
