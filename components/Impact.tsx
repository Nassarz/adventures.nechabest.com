...
import { TreePine, Binoculars, Users, Handshake } from 'lucide-react';
import { useSiteContent } from '@/hooks/useSiteContent';

const statIcons = [TreePine, Binoculars, Users, Handshake];
...
export default function Impact() {
  ...
  const stats = [
    { value: get('home.impact.stat1.value', '5,000+'), label: get('home.impact.stat1.label', 'Happy Travelers'), icon: statIcons[0], color: statColors[0] },
    { value: get('home.impact.stat2.value', '50+'), label: get('home.impact.stat2.label', 'Tour Packages'), icon: statIcons[1], color: statColors[1] },
    { value: get('home.impact.stat3.value', '200+'), label: get('home.impact.stat3.label', 'Local Guides'), icon: statIcons[2], color: statColors[2] },
    { value: get('home.impact.stat4.value', '15+'), label: get('home.impact.stat4.label', 'Years Experience'), icon: statIcons[3], color: statColors[3] },
  ];
          ...
          >
            <div className="space-y-3 md:space-y-4">
              ...
              >
                ...
                <span className="text-nature font-bold uppercase tracking-[0.3em] text-[10px] md:text-xs block">
                  {get('home.impact.kicker', 'Why Travel With Us')}
                </span>
              </motion.div>
